...
;
 CREATE CLUSTERED COLUMNSTORE INDEX idx ON #ObservationCrit11_1;
...
(
  ...
  FROM 
  (
  SELECT * FROM #ObservationCrit11_1
...
-- DELETE TEMP TABLES
 TRUNCATE TABLE #ObservationCrit11_1;
DROP TABLE #ObservationCrit11_1;
