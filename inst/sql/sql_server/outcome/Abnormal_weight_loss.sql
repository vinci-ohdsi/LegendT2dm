...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (435928,40303297)
...
;
 CREATE CLUSTERED COLUMNSTORE INDEX idx ON #ObservationCrit12_1;
...
(
  ...
  FROM 
  (
  SELECT * FROM #ObservationCrit12_1
...
-- DELETE TEMP TABLES
 TRUNCATE TABLE #ObservationCrit12_1;
DROP TABLE #ObservationCrit12_1;
